...
- **v0.7** — shared world consolidation: ledger → region state, shared scenes/party play via `world/scenes/` polling, world-level time mode. Ability economy depth, skills growth, NPC relationship arcs.
