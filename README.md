...
- **v0.4.x** — world-tick: ledger → region state consolidation, event stage advancement, news spread between communities (deed `spread`), real-time mode ticking world events while away — and offscreen NPC evolution (people grow while you're gone).
