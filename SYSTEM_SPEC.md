...
| **HEAD verified** | BATCH-11 at **v1.8.105** · confirmed against origin: 70 engine modules · 41 core rules files · 96 locations / 25 regions · 285 abilities / 24 traditions (+3 folk) · 44 combinations · 41 NPCs · 9 companions · 58 random-encounter entries. **Count freshness is now machine-gated** — `tests/wiring_audit.mjs` fails the build when this line drifts from HEAD (the 38/137-era drift, found by BATCH-11 §0, must not recur silently). |
