...
| **HEAD verified** | BATCH-11 at **v1.8.105** · confirmed against origin: 83 engine modules · 52 core rules files · 118 locations / 26 regions · 354 abilities / 24 traditions (+3 folk) · 44 combinations · 41 NPCs · 9 companions · 58 random-encounter entries. **Count freshness is now machine-gated** — `tests/wiring_audit.mjs` fails the build when this line drifts from HEAD (the 38/137-era drift, found by BATCH-11 §0, must not recur silently). |
