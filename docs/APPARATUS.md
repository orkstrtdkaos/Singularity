...
**Last measured: 2026-09-21 · v2.4.4 · 111 files.**
...
| `tests/how_it_works` | ✅ GATE | 3386 | CCODE-285 |
| `tests/skill_battle_sim` | ✅ GATE | 217 | SNG-098: the two-sided contest + fog-of-war invariant |
| `tests/content_ci` | ✅ GATE | 196 | SNG-BATCH-10 Phase 4 / SNG-040/064: the content integrity gate |
