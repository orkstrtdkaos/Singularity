...
well oiled.** 114 harnesses across `tests/` and `scripts/`, and before this document nobody could say which
...
**Last measured: 2026-09-24 · v2.6.0 · 114 files.**
...
| `tests/how_it_works` | ✅ GATE | 3473 | CCODE-285 |
