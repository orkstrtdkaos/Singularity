...
**The world is called EXESA.** For a long time it had no name at all, and *"the valley"* — one region of
...
```
Precursor is to ordered nanite as Veil is to metaphysical
```
...
Wild nanite has one: the gaps. It thrives in the places nobody is maintaining, which is why the
...
A hundred and nineteen great figures walk Exesa, spread across a hundred and forty-three authored places — and
...
*Mind is the only domain holding three sects and three separate power sources.*
...
The waygates and the archives that run forward are both Precursor works — Span walks on someone
