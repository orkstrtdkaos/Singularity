...
|---|---|---|---|---|
| `tree[].gainAxes` | rank node | **1009 nodes / 834 values** | ⛔ **the KINDS-OF-IMPROVEMENT list (9)** | ✅ `capabilities.js` — **for PRESENCE only** |
...
- ⛔ **`gainAxes` DECIDES WHICH RANKS APPEAR IN THE PLAYER'S CAPABILITY MENU.** The chain is
  ...
  switches on *which* kind of improvement it names. **So the field is load-bearing and the 834 individual values are
...
|---|---|---|---|---|
| `rank` | 1610 | `tree`×1098 `rankDeltas`×512 | ✅ READ | `braids.js`, `capabilities.js`, `coliseum.js` |
| `name` | 1489 | `root`×391 `tree`×1098 | ✅ READ | `affiliation.js`, `arceffects.js`, `art.js` |
| `functions` | 1489 | `root`×391 `tree`×1098 | ✅ READ | `braids.js`, `coliseum.js`, `craftmechanics.js` |
| `harmRung` | 1391 | `root`×366 `tree`×1025 | ✅ READ | `braids.js`, `gm_registry.js`, `intent.js` |
| `grants` | 1098 | `tree`×1098 | ✅ READ | `braids.js`, `capabilities.js`, `earnedpower.js` |
| `cannot` | 1098 | `tree`×1098 | ✅ READ | `authormode.js`, `braids.js`, `capabilities.js` |
| `gains` | 1068 | `tree`×1068 | ✅ READ | `encounters.js`, `gm.js`, `roundreceipt.js` |
| `gainAxes` | 1009 | `tree`×1009 | ✅ READ | `capabilities.js` |
...
| `id` | 391 | `root`×391 | ✅ READ | `affinities.js`, `arceffects.js`, `art.js` |
| `axes` | 391 | `root`×391 | ✅ READ | `affinities.js`, `craftmechanics.js`, `encounters.js` |
| `attribute` | 391 | `root`×391 | ✅ READ | `affinities.js`, `braids.js`, `corrections.js` |
| `narrationHints` | 391 | `root`×391 | ✅ READ | `battleprompt.js`, `braids.js`, `companions.js` |
| `description` | 391 | `root`×391 | ✅ READ | `affiliation.js`, `art.js`, `authormode.js` |
| `notFor` | 391 | `root`×391 | ✅ READ | `braids.js`, `entityDetail.js`, `generate.js` |
| `tradition` | 391 | `root`×391 | ✅ READ | `arceffects.js`, `art.js`, `braids.js` |
| `powerSystem` | 391 | `root`×391 | ✅ READ | `art.js`, `backfill.js`, `braids.js` |
| `operativeAxis` | 391 | `root`×391 | ⚠️ COLLISION | only as `cfg.operativeAxis` |
| `intensity` | 391 | `root`×391 | ✅ READ | `canon.js`, `craftmechanics.js`, `death.js` |
| `bounds` | 391 | `root`×391 | ✅ READ | `gm.js` |
| `plainly` | 391 | `root`×391 | ✅ READ | `gm.js`, `narration_voice.js`, `app.js` |
| `tree` | 391 | `root`×391 | ✅ READ | `backfill.js`, `braids.js`, `capabilities.js` |
| `mechanic` | 384 | `root`×384 | ✅ READ | `braids.js`, `capabilities.js`, `conditions.js` |
| `challengeTypes` | 376 | `root`×376 | ⚠️ CI-ONLY | _4 test/script only_ |
| `energyCost` | 373 | `root`×373 | ✅ READ | `braids.js`, `capabilities.js`, `functions.js` |
| `levelReq` | 366 | `root`×366 | ✅ READ | `backfill.js`, `braids.js`, `company.js` |
| `nativeOrCombination` | 366 | `root`×366 | ✅ READ | `braids.js`, `functions.js`, `practice.js` |
| `shape` | 366 | `root`×366 | ✅ READ | `battleprompt.js`, `company.js`, `craftmechanics.js` |
| `duration` | 292 | `mechanic`×292 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `npcsheet.js` |
...
| `note` | 211 | `mechanic`×211 | ✅ READ | `art.js`, `authormode.js`, `borncontract.js` |
| `effectTags` | 167 | `root`×167 | ✅ READ | `battleprompt.js`, `braids.js`, `martial.js` |
| `scope` | 137 | `mechanic`×137 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `app.js` |
| `targets` | 121 | `mechanic`×121 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `skill_battle.js` |
...
| `crit` | 70 | `mechanic`×70 | ✅ READ | `craftmechanics.js`, `encounters.js`, `npcsheet.js` |
