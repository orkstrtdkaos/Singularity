...
| `psychic_lance` · `unbearable_word` · `felt_wall` — reach a mind, a knowing, an intent | `who_falls_first` — reads **capability**, and ⚠️ **a crew of constructs has capabilities too** |
