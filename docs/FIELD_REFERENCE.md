...
|---|---|---|---|---|
| `tree[].gainAxes` | rank node | **982 nodes / 798 values** | ⛔ **the KINDS-OF-IMPROVEMENT list (9)** | ✅ `capabilities.js` — **for PRESENCE only** |
...
- ⛔ **`gainAxes` DECIDES WHICH RANKS APPEAR IN THE PLAYER'S CAPABILITY MENU.** The chain is
  ...
  switches on *which* kind of improvement it names. **So the field is load-bearing and the 798 individual values are
...
|---|---|---|---|---|
| `rank` | 1583 | `tree`×1071 `rankDeltas`×512 | ✅ READ | `braids.js`, `capabilities.js`, `coliseum.js` |
| `name` | 1453 | `root`×382 `tree`×1071 | ✅ READ | `affiliation.js`, `arceffects.js`, `art.js` |
| `functions` | 1453 | `root`×382 `tree`×1071 | ✅ READ | `braids.js`, `coliseum.js`, `craftmechanics.js` |
| `harmRung` | 1355 | `root`×357 `tree`×998 | ✅ READ | `braids.js`, `gm_registry.js`, `intent.js` |
| `grants` | 1071 | `tree`×1071 | ✅ READ | `braids.js`, `capabilities.js`, `earnedpower.js` |
| `cannot` | 1071 | `tree`×1071 | ✅ READ | `authormode.js`, `braids.js`, `capabilities.js` |
| `gains` | 1041 | `tree`×1041 | ✅ READ | `encounters.js`, `gm.js`, `roundreceipt.js` |
| `gainAxes` | 982 | `tree`×982 | ✅ READ | `capabilities.js` |
...
| `id` | 382 | `root`×382 | ✅ READ | `affinities.js`, `arceffects.js`, `art.js` |
| `axes` | 382 | `root`×382 | ✅ READ | `affinities.js`, `craftmechanics.js`, `encounters.js` |
| `attribute` | 382 | `root`×382 | ✅ READ | `affinities.js`, `braids.js`, `corrections.js` |
| `narrationHints` | 382 | `root`×382 | ✅ READ | `battleprompt.js`, `braids.js`, `companions.js` |
| `description` | 382 | `root`×382 | ✅ READ | `affiliation.js`, `art.js`, `authormode.js` |
| `notFor` | 382 | `root`×382 | ✅ READ | `braids.js`, `entityDetail.js`, `generate.js` |
| `tradition` | 382 | `root`×382 | ✅ READ | `arceffects.js`, `art.js`, `braids.js` |
| `powerSystem` | 382 | `root`×382 | ✅ READ | `art.js`, `backfill.js`, `braids.js` |
| `operativeAxis` | 382 | `root`×382 | ⚠️ COLLISION | only as `cfg.operativeAxis` |
| `intensity` | 382 | `root`×382 | ✅ READ | `canon.js`, `craftmechanics.js`, `death.js` |
| `bounds` | 382 | `root`×382 | ✅ READ | `gm.js` |
| `plainly` | 382 | `root`×382 | ✅ READ | `gm.js`, `narration_voice.js`, `app.js` |
| `tree` | 382 | `root`×382 | ✅ READ | `backfill.js`, `braids.js`, `capabilities.js` |
| `mechanic` | 375 | `root`×375 | ✅ READ | `braids.js`, `capabilities.js`, `conditions.js` |
| `challengeTypes` | 367 | `root`×367 | ⚠️ CI-ONLY | _4 test/script only_ |
| `energyCost` | 364 | `root`×364 | ✅ READ | `braids.js`, `capabilities.js`, `functions.js` |
| `levelReq` | 357 | `root`×357 | ✅ READ | `backfill.js`, `braids.js`, `company.js` |
| `nativeOrCombination` | 357 | `root`×357 | ✅ READ | `braids.js`, `functions.js`, `practice.js` |
| `shape` | 357 | `root`×357 | ✅ READ | `battleprompt.js`, `company.js`, `craftmechanics.js` |
| `rankDeltas` | 284 | `root`×284 | ✅ READ | `craftmechanics.js` |
| `duration` | 283 | `mechanic`×283 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `npcsheet.js` |
| `magnitude` | 280 | `mechanic`×280 | ✅ READ | `capabilities.js`, `conditions.js`, `craftmechanics.js` |
| `note` | 202 | `mechanic`×202 | ✅ READ | `art.js`, `authormode.js`, `borncontract.js` |
| `effectTags` | 158 | `root`×158 | ✅ READ | `battleprompt.js`, `braids.js`, `martial.js` |
| `scope` | 135 | `mechanic`×135 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `app.js` |
| `targets` | 113 | `mechanic`×113 | ✅ READ | `capabilities.js`, `craftmechanics.js`, `skill_battle.js` |
