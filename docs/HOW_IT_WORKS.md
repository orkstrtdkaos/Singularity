...
**Last verified: 2026-09-19 · v2.1.0 · 432 crafts.**
...
whole interface is **`app.js`, 19,749 lines**, and there are **52 `render*` functions** that paint into one
shell function, `chrome()`, called from **54 sites**. ⚠️ **THERE IS NO ROUTER AND NO SCREEN VARIABLE.**
