...
| 08-29 | ✅ **`dread` SPLIT — `worn_grey` authored** | Erik: *"seems like a lot stacked onto Dread Mantle"* — ⛔ it carried **four** mechanics, and `wornBenefits` **is not a fear craft at all** | `craft_lint ashwarden` 4 · gates green | ⛔ **the tell was in the text: both wearer-effects were bolted to the END of r2 and r3 with *"AND the mantle is on you"*.** Dread keeps what it does to OTHERS; Worn Grey keeps what it does to the WEARER |
| 08-29 | ✅ **`bark_and_briar` thorns now CUT** | Erik: *"should get damaging thorns as it ranks"* | 1d6 at r2, 2d6 at r3, `physical` | ⚠️ **the craft already said *"thorns that make you COSTLY to grapple"* and dealt nothing** — costly was a word with no number behind it |
...
**Last verified: 2026-08-28 · v1.9.262 · 382 crafts.**
