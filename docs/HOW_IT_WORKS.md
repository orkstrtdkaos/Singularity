...
| 08-29 | ⛔ **TWO OF MY THREE "INVERSIONS" WERE WRONG — REVERSED** | ⚠️ Erik: *"I'm concerned you might not be paying enough attention to the specifics of each craft."* **`second_wind` and `perfect_motion` deal NO damage** — no dice, functions `sustain/resist/empower` — and *"your blows land harder"* makes the CHARACTER'S weapon better | ⛔ **the lint reports a DISAGREEMENT and cannot say which side is wrong. I assumed the ability was, and propagated a rank's error upward** | ⚠️ only `quick_hands` was a true inversion — its r2 declares `strike` and deals 1d6 |
...
**Last verified: 2026-08-28 · v1.9.259 · 378 crafts.**
