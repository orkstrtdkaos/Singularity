...
**Last verified: 2026-09-17 · v2.0.49 · 431 crafts.**
...
`local_layouts.json` places **84 sites across 18 of 140 locations** — a well at a centre, a river 2.2 miles
...
whole interface is **`app.js`, 18,053 lines**, and there are **51 `render*` functions** that paint into one
