...
**Last verified: 2026-09-14 · v1.9.519 · 429 crafts.**
...
whole interface is **`app.js`, 16,754 lines**, and there are **51 `render*` functions** that paint into one
shell function, `chrome()`, called from **51 sites**. ⚠️ **THERE IS NO ROUTER AND NO SCREEN VARIABLE.**
