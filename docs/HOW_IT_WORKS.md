...
| 08-29 | ⛔ **NEW CANON: AT ~L100 YOU ASCEND OR FALL ACROSS THE VEIL** | Erik: *"they will go to join the primary conflict. So the World's MYTHICALS are those high near-level-100 NPCs"* | — authored in `legends.json` as a fourth tier + `_theMythicalRung` | ⛔ **it makes `arc_the_disagreement` REACHABLE — the endgame is not defeating the Precursors, it is BECOMING ONE OF THE PARTIES** |
...
**Last verified: 2026-08-28 · v1.9.260 · 378 crafts.**
