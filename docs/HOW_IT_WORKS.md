...
**Last verified: 2026-09-08 · v1.9.422 · 429 crafts.**
...
| ⛔ **three hinge NPCs on four greater arcs resolve to NO record** | `npcs/legends.json`'s own `legends[]` — Seraphine, Corvane, the Concordat, Aevi the Watcher — is read by nothing; `state.js` said they were hydrated from `legends.roster`, and they are not. ⚠️ Corvane the Deep Warden hinges 4 of 6 arcs. Left unhydrated ON PURPOSE (they carry `renown`, not `tier`; hydrating makes Corvane a level-1 opponent). ⬜ **Erik's call: people-records, or `hingeNpcs` re-pointed** — see `docs/ROSTER.md` |
