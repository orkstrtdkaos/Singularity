...
**Last verified: 2026-09-19 · v2.0.82 · 432 crafts.**
...
whole interface is **`app.js`, 19,177 lines**, and there are **51 `render*` functions** that paint into one
shell function, `chrome()`, called from **53 sites**. ⚠️ **THERE IS NO ROUTER AND NO SCREEN VARIABLE.**
