...
**GENERATED by `scripts/roster.mjs` · 184 records across 6 files · 165 reachable as opponents · 5 would fight at level 1 · 0 carry only the bare strike · 3 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.
...
| ⚠️ reachable with no AUTHORED level (tier floor or derived) | 106 | of 165 reachable |
| ⚠️ reachable with no authored `abilities` (kit drawn from domains) | 119 | of 165 reachable |
...
|---|---|---|
| person | **108** | single authored people — the ones you can MEET |
