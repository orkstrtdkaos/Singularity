...
**GENERATED by `scripts/roster.mjs` · 190 records across 6 files · 171 reachable as opponents · 5 would fight at level 1 · 0 carry only the bare strike · 3 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.
...
| ⚠️ reachable with no AUTHORED level (tier floor or derived) | 105 | of 171 reachable |
| ⚠️ reachable with no authored `abilities` (kit drawn from domains) | 125 | of 171 reachable |
...
|---|---|---|
| person | **114** | single authored people — the ones you can MEET |
