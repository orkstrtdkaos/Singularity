...
**GENERATED by `scripts/roster.mjs` · 187 records across 6 files · 168 reachable as opponents · 5 would fight at level 1 · 0 carry only the bare strike · 3 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.
...
| ⚠️ reachable with no AUTHORED level (tier floor or derived) | 106 | of 168 reachable |
| ⚠️ reachable with no authored `abilities` (kit drawn from domains) | 122 | of 168 reachable |
...
|---|---|---|
| person | **111** | single authored people — the ones you can MEET |
...
| `high_luminary` | High Luminary Sera | person | `npcs/high_luminary.json` | legendary | →60 | — | ✅ | ✅ | 25 | — | — |
