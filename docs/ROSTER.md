...
**GENERATED by `scripts/roster.mjs` · 171 records across 6 files · 152 reachable as opponents · 5 would fight at level 1 · 0 carry only the bare strike · 3 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.
