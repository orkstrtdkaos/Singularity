...
> ⚑ **The great figures** — heroic and above, with whole names (GM-eyes), their place in the Sovereign story and their vectors — are in [`docs/GREAT_FIGURES.md`](GREAT_FIGURES.md), generated by `po/tools/great_figures.cjs`.

<!-- BEGIN roster-generated -->
**GENERATED by `scripts/roster.mjs` · 200 records across 6 files · 181 reachable as opponents · 5 would fight at level 1 · 0 carry only the bare strike · 3 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.

### ⛔ WHAT THE TABLE FOUND

| finding | count | who |
|---|---|---|
| ⛔ **reachable as an opponent and would fight at LEVEL 1** (no authored level, no tier floor) | **5** | `burr_the_foundling` · `child_wren` · `odd_wren` · `young_ent_lissome` · `young_hollis` |
| ⚠️ reachable with no AUTHORED level (tier floor or derived) | 105 | of 181 reachable |
| ⚠️ reachable with no authored `abilities` (kit drawn from domains) | 125 | of 181 reachable |
| ⛔ **reachable but the ONLY move is the bare strike** (no real craft) | **0** |  |
| ⚑ tier DERIVED from the role string, not authored | 3 | notable — shown as `~name` in the tier column |
...
|---|---|---|
| person | **124** | single authored people — the ones you can MEET |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `adept_sona` | Sona of the Middle Way | person | `npcs/adept_sona.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
...
| `aldous_thorne_border` | Aldous Thorne, Who Changes at the Border | person | `npcs/aldous_thorne_border.json` | leader | 19 | 7 | ✅ | ✅ | 10 | 2 | — |
| `archive_guardian` | The Archive Guardian | person | `npcs/archive_guardian.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `archivist_lom` | Archivist Lom | person | `npcs/archivist_lom.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `aro_horizon` | Aro of the Horizon Reach | person | `npcs/aro_horizon.json` | heroic | 26 | 8 | ✅ | ✅ | 13 | 2 | — |
| `asterion_given_maze` | Asterion of the Given Maze | person | `npcs/asterion_given_maze.json` | heroic | 34 | 7 | ✅ | ✅ | 17 | 2 | — |
| `azhar_unfinished_wish` | Azhar of the Unfinished Wish | person | `npcs/azhar_unfinished_wish.json` | epic | 45 | 7 | ✅ | ✅ | 21 | 2 | — |
| `brann_tollhand` | Brann Tollhand | person | `npcs/brann_tollhand.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `bren-thalle` | Bren Thalle | person | `npcs/bren-thalle.json` | riffraff | 9 | 6 | ✅ | ✅ | 6 | 2 | — |
| `bricke_making` | Bricke of the Making | person | `npcs/bricke_making.json` | heroic | 23 | 8 | ✅ | ✅ | 12 | 2 | — |
| `broker_sain` | Sain of the Quiet House | person | `npcs/broker_sain.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `burr_the_foundling` | Burr | person | `npcs/burr_the_foundling.json` | riffraff | →1 | — | ✅ | ✅ | 1 | — | — |
| `calvar` | Calvar | person | `npcs/calvar.json` | leader | 22 | 8 | ✅ | ✅ | 11 | 2 | — |
| `cassa_redsail` | Cassa Redsail | person | `npcs/cassa_redsail.json` | heroic | 27 | 16 | ✅ | ✅ | 16 | 2 | — |
| `cassiel-ord` | Cassiel Ord | person | `npcs/cassiel_ord.json` | notable | →5 | — | ✅ | ✅ | 3 | 2 | — |
| `castellan_brannoch` | Castellan Brannoch | person | `npcs/castellan_brannoch.json` | notable | 18 | — | ✅ | ✅ | 9 | 2 | — |
| `ceriad` | Ceriad of the Harborward | person | `npcs/ceriad.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `champion_vael` | Vael of the Redline | person | `npcs/champion_vael.json` | heroic | →25 | — | ✅ | ✅ | 12 | — | — |
| `chief_kettering` | Chief Kettering | person | `npcs/chief_kettering.json` | heroic | 27 | — | ✅ | ✅ | 13 | 2 | — |
| `child_wren` | Wren | person | `npcs/child_wren.json` | riffraff | →1 | — | ✅ | ✅ | 1 | — | — |
| `cogitant_ninefold` | The Cogitant Ninefold | person | `npcs/cogitant_ninefold.json` | heroic | →25 | — | ✅ | ✅ | 12 | — | — |
| `councilor-dresh` | Councilor Dresh | person | `npcs/councilor_dresh.json` | leader | 12 | — | ✅ | ✅ | 6 | 2 | — |
| `custodian_vantrel` | Custodian Vantrel | person | `npcs/custodian_vantrel.json` | heroic | 27 | — | ✅ | ✅ | 13 | 2 | — |
| `dame_iseult_hardline` | Iseult of the Kept Word | person | `npcs/dame_iseult_hardline.json` | epic | 42 | 16 | ✅ | ✅ | 21 | 2 | — |
| `dara-holt` | Dara Holt | person | `npcs/dara_holt.json` | leader | 12 | — | ✅ | ✅ | 6 | 1 | — |
| `deni-cors` | Deni Cors | person | `npcs/deni_cors.json` | notable | →5 | — | ✅ | ✅ | 3 | 2 | — |
| `dessa_wyck` | Dessa Wyck | person | `npcs/dessa_wyck.json` | notable | 14 | — | ✅ | ✅ | 7 | 2 | — |
| `edvar-crane` | Edvar Crane | person | `npcs/edvar-crane.json` | notable | →5 | — | ✅ | ✅ | 3 | 2 | — |
| `elder_resonance` | Elder Resonance | person | `npcs/elder_resonance.json` | heroic | →25 | — | ✅ | ✅ | 12 | — | — |
| `elder-senna` | Elder Senna | person | `npcs/elder_senna.json` | leader | 12 | — | ✅ | ✅ | 6 | 1 | — |
| `evander_morrow_unlaid` | Evander Morrow, Who Would Not Be Laid Down | person | `npcs/evander_morrow_unlaid.json` | epic | 48 | 7 | ✅ | ✅ | 22 | 2 | — |
| `farren` | Farren Quire | person | `npcs/farren.json` | notable | 20 | — | ✅ | ✅ | 10 | 1 | — |
| `fendt` | Fendt | person | `npcs/fendt.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `greta_waystation` | Greta | person | `npcs/greta_waystation.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `hallis_pale` | Hallis of the Palelands | person | `npcs/hallis_pale.json` | heroic | 27 | 8 | ✅ | ✅ | 14 | 2 | — |
| `harl_maddock` | Harl Maddock | person | `npcs/harl_maddock.json` | heroic | 31 | — | ✅ | ✅ | 14 | 2 | — |
| `harrow_the_hollowing` | Harrow, Who Makes People Into Mechanisms | person | `npcs/harrow_the_hollowing.json` | legendary | 66 | 16 | ✅ | ✅ | 31 | 2 | — |
| `hierarch_brightmantle` | Hierarch Brightmantle | person | `npcs/hierarch_brightmantle.json` | heroic | 30 | — | ✅ | ✅ | 14 | 2 | — |
| `illeth_turned_coat` | Illeth, Queen of the Turned Coat | person | `npcs/illeth_turned_coat.json` | epic | 52 | 8 | ✅ | ✅ | 24 | 2 | — |
| `ines_harrowgate` | Ines Harrowgate | person | `npcs/ines_harrowgate.json` | heroic | 25 | — | ✅ | ✅ | 12 | 2 | — |
| `keeper_ilma` | Ilma, Keeper of the Board | person | `npcs/keeper_ilma.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
...
| `kestrin_riven` | Kestrin of the Riven Marches | person | `npcs/kestrin_riven.json` | heroic | 24 | 8 | ✅ | ✅ | 12 | 2 | — |
| `lenten` | Lenten | person | `npcs/lenten.json` | notable | →5 | — | ✅ | ✅ | 3 | 2 | — |
| `lucifer` | Lucifer | person | `npcs/lucifer.json` | mythic | 85 | 7 | ✅ | ✅ | 35 | — | — |
| `lys_vane` | Lys of the Veiled Reach | person | `npcs/lys_vane.json` | heroic | 22 | 8 | ✅ | ✅ | 11 | 2 | — |
| `maker_orrin` | Orrin Nine-Thumbs | person | `npcs/maker_orrin.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `mara-wells` | Mara Wells | person | `npcs/mara-wells.json` | notable | 14 | 6 | ✅ | ✅ | 7 | 2 | — |
...
| `pell-sethry` | Pell Sethry | person | `npcs/pell_sethry.json` | notable | →5 | — | ✅ | ✅ | 3 | 2 | — |
| `planmaster_wyncote` | Planmaster Wyncote | person | `npcs/planmaster_wyncote.json` | heroic | 26 | — | ✅ | ✅ | 12 | 2 | — |
| `quillon_vey_unending` | Quillon Vey, the Proof That Will Not End | person | `npcs/quillon_vey_unending.json` | legendary | 66 | 8 | ✅ | ✅ | 29 | 2 | — |
| `reed_mother_ossa` | Reed-Mother Ossa | person | `npcs/reed_mother_ossa.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `rootbound_vaskar` | Vaskar the Rootbound | person | `npcs/rootbound_vaskar.json` | heroic | →25 | — | ✅ | ✅ | 12 | — | — |
| `sable_the_runner` | Sable | person | `npcs/sable_the_runner.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `seren_unlooked_at` | Seren, Who Is Not Looked At | person | `npcs/seren_unlooked_at.json` | heroic | 29 | 6 | ✅ | ✅ | 15 | 2 | — |
...
| `silas-mother` | Hesta Vorn | person | `npcs/silas-mother.json` | notable | 18 | 8 | ✅ | ✅ | 9 | 2 | — |
| `siol` | Siol | person | `npcs/siol.json` | heroic | 26 | 9 | ✅ | ✅ | 13 | 2 | — |
| `sister_vreni` | Sister Vreni | person | `npcs/sister_vreni.json` | leader | →12 | — | ✅ | ✅ | 6 | 2 | — |
| `solvace` | Solvace of Glasshome | person | `npcs/solvace.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `sorel` | Sorel Halloran | person | `npcs/sorel.json` | notable | 15 | — | ✅ | ✅ | 8 | 1 | — |
| `speaker_istvane` | Speaker Istvane | person | `npcs/speaker_istvane.json` | heroic | 28 | — | ✅ | ✅ | 12 | 2 | — |
...
| `tamsin_galt` | Tamsin Galt | person | `npcs/tamsin_galt.json` | notable | 19 | — | ✅ | ✅ | 10 | 2 | — |
| `tender_ovel` | Ovel | person | `npcs/tender_ovel.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `teva` | Teva | person | `npcs/teva.json` | notable | →5 | — | ✅ | ✅ | 3 | 3 | — |
| `the_awakened_precursor` | Vessenaia, the Listening Half | person | `npcs/the_awakened_precursor.json` | epic | →40 | — | ✅ | ✅ | 18 | 3 | — |
...
| `the_ferryman_tam` | Tam the Ferryman | person | `npcs/the_ferryman_tam.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
...
| `the_kestrel` | The Kestrel | person | `npcs/the_kestrel.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
...
| `the_old_stag` | The Old Stag | person | `npcs/the_old_stag.json` | heroic | →25 | — | ✅ | ✅ | 12 | — | — |
...
| `the_unfinished_of_the_last_cairn` | Orsolya, Who Would Not Be Told | person | `npcs/the_unfinished_of_the_last_cairn.json` | legendary | →60 | — | ✅ | ✅ | 26 | 3 | — |
...
| `tuning-warden-lower-terrace` | Maren Vasse | person | `npcs/tuning_warden_lower_terrace.json` | notable | 16 | — | ✅ | ✅ | 8 | 2 | — |
| `vantia_stillhold` | Vantia of the Stillhold | person | `npcs/vantia_stillhold.json` | heroic | 23 | 8 | ✅ | ✅ | 12 | 2 | — |
...
| `walker_elder_thren` | Thren, Walker of the Thin Edge | person | `npcs/walker_elder_thren.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `warden_isolde` | Warden Isolde | person | `npcs/warden_isolde.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `warden_mother_redgate` | Warden-Mother Redgate | person | `npcs/warden_mother_redgate.json` | heroic | 27 | — | ✅ | ✅ | 13 | 2 | — |
| `warden-coll` | Warden Coll | person | `npcs/warden_coll.json` | leader | →12 | — | ✅ | ✅ | 6 | 2 | — |
| `water_keeper` | Mara Wells, the Water Keeper | person | `npcs/water_keeper.json` | notable | →5 | — | ✅ | ✅ | 3 | — | — |
| `wend_elder_saba` | Saba of the Long Road | person | `npcs/wend_elder_saba.json` | leader | →12 | — | ✅ | ✅ | 6 | — | — |
| `young_ent_lissome` | Lissome | person | `npcs/young_ent_lissome.json` | riffraff | →1 | — | ✅ | ✅ | 1 | — | — |
| `young_hollis` | Hollis | person | `npcs/young_hollis.json` | riffraff | →1 | — | ✅ | ✅ | 1 | — | — |
...
| `halvex_coil` | Halvex Coil, the Rewriter | lore figure | `lore/legends.json` | legendary | →60 | — | ✅ | ✅ | 21 | — | — |
...
| `the_appetite` | The Appetite | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_archive_that_walks` | The Archive That Walks | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_bridgewright` | The One Who Bridged the Unbridgeable | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_clockmother` | The Clockmother, Who Keeps the Deep Hour | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_cogitant_ninefold` | Rethe, Who Is Becoming the Engine | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_cornerstone` | The Cornerstone | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_deep_lantern` | The Deep Lantern, Who Walks Where Light Won't | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_doubting_lattice` | The One Who Doubts the Proof | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_edge_seeker` | The One Who Walks Toward the Edge | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_edge_that_holds` | Kesh Ardent, the Edge That Holds | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_ender_who_forgot` | The Ender Who Forgot Why | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_farwalker` | The Farwalker | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_final_argument` | The Final Argument | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_first_moot` | The One Who Called the First Moot | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_gate_that_gapes` | The Gate That Gapes | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_glad_dissolution` | The Glad Dissolution | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_hour_hoarder` | The Hour-Hoarder | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_hundred_faces` | The One With a Hundred Faces | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_hundred_hands` | The Hundred Hands | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_kind_liar` | The Kind Liar | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_last_mercy` | The Last Mercy | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_last_seraph` | The Last Seraph of the Pre-Transition Choir | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_last_walker` | The Last Walker of the Sealed Wood | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_lidded_calm` | The Lidded Calm | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_long_grudge` | The One Who Has Not Forgotten | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_lost_chord_seeker` | Seeker of the Lost Chord | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_nine_year_master` | The Nine-Year Master | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_oathbreaker_sel` | Sel Who Broke the Warding | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_one_called_ares` | The One Called Ares | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_one_called_athena` | The One Called Athena | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_one_called_loki` | The One Called Loki | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_one_called_zeus` | The One Called Zeus | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_one_who_stayed_embodied` | The One Who Stayed Embodied | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_open_figure` | The Open Figure | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_pattern_prophet` | The One Who Reads the Coming Shape | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_penitent_maw` | The Penitent Maw | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_two_who_are_one` | The Two Who Are One | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_unbending_witness` | Seraphine the Unbending Witness | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `the_unbound_churn` | The Unbound | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_undefeated` | Saehara the Undefeated | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_unravelled_mind` | The Unravelled Mind | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_war_ender` | The One Who Ended the Long War | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
| `the_weeping_archive` | The Weeping Archive | epic | `tradition_epics.json` | epic | →40 | — | ✅ | ✅ | 15 | — | — |
| `vessa_truename` | Vessa Who Trades in True Names | epic | `tradition_epics.json` | heroic | →25 | — | ✅ | ✅ | 10 | — | — |
