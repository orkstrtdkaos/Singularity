...
**GENERATED by `scripts/roster.mjs` · 162 records across 6 files · 143 reachable as opponents · 0 would fight at level 1 · 57 carry only the bare strike · 42 tiers derived from a role · 1 authored but never loaded.** ⚠️ Regenerate with `node scripts/roster.mjs --write`; never hand-edit inside the markers.
