...
REPLY FORMAT — a single JSON object, no other text:
{
  ...
  "debtOps": [{"op": "record|settle|forgive", "holderId": "npcId who is OWED and remembers it", "kind": "abandoned-holding|broken-terms|unpaid-price", "amount": "number, or null when it is not a money debt", "currency": "crystal (never coin)", "reason": "one line: what is owed and why"}],
...
export const ASK_FORBIDDEN = ["scene", "choices", "moveTo", "newEncounter", "deathOps", "strikeOps", "holdTrades", "imagePrompt", "imageMedium", "intentsHeard",
