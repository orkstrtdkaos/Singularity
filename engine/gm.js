...
REPLY FORMAT — a single JSON object, no other text:
{
  ...
  "holdingOps": [{"op": "claim|steward|release|transfer", "id": "kebab-id", "toEntity": "npcId who takes it up (transfer only)", "kind": "post|enterprise", "name": "what it is called", "locationId": "where it is", "steward": "npcId who keeps it, or null", "obligation": "what it owes, in one line"}],
