...
${standingDetail}`);
  ...
  if (teacherDetail) scene.push(`## YOUR TEACHERS (rule 16B — at most one offer a beat, and only when the moment fits; a teacher may also judge the character NOT READY, which is a real and interesting answer)
${teacherDetail}`);
