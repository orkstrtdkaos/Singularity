...
REPLY FORMAT — a single JSON object, no other text:
{
  ...
  "deriveItem": {"parent": "the exact name of the OWNED item this splits from", "name": "the new item's name", "customName": "its truer name (optional)", "kind": "weapon|tool|consumable|quest|misc", "description": "what it is", "provenance": "how it was split off", "imagePrompt": "what it looks like", "grants": [{"name": "...", "from": "...", "effect": "...", "clamp": "..."}]},
