...
REPLY FORMAT — a single JSON object, no other text:
{
  ...
  "holdingOps": [{"op": "claim|steward|release|transfer|sell|improve|crew|garrison", "id": "kebab-id", "abilityId": "the craft applied (improve only)", "npcId": "the person (crew/garrison — the whole list replaces the old one; pass npcIds for several)", "toEntity": "npcId who takes it up (transfer only)", "kind": "post|enterprise", "name": "what it is called", "locationId": "where it is", "steward": "npcId who keeps it, or null", "obligation": "what it owes, in one line"}],
