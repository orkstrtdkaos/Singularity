...
REPLY FORMAT — a single JSON object, no other text:
{
  ...
  "deathOps": [{"op": "hold | slow | retrieve | release", "npcId": "a DEAD npc in the registry", "abilityId": "the craft used (retrieve only)", "intensity": "standard | surge", "outcome": "return | fail", "willing": true}],
