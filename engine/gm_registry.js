...
export const GM_CONTEXT = [
  ...
  { key: "worldPressureDetail", builder: "app pendingPressure (SNG-080) · pressure.nextInvitation (CCODE-410)", carries: ["quiet-turn world push", "an invitation bound to this character, brought in person by its giver — once (CCODE-410)"],
    reachedBy: "always (paced) — or an invitation waiting in the queue with room this beat (pacing.roomForAnInvitation)", spec: "§19", views: ["turn"],
