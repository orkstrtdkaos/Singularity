...
export async function loadContent() {
  ...
  const [region, substrate, greaterArcs, genNpc, genLoc, genArc, originsDoc, backgroundsDoc, regionsDoc,
         accords, helpDoc, substrateModel, prologue, legendsLoaded, traitReadoutsDoc, traditionAestheticsDoc, frameContentDoc, frameKindsDoc, receiptLineDoc] = await Promise.all([
