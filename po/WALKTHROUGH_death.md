...
**grants:** ⛔ MARROW TELLS YOU WHAT IS ENDING, HOW, AND WHETHER IT WAS NATURAL OR MADE — and reads things that are not bodies: a truce, a road, a house, a season's grain, a marriage. It tells you before you ask.

**cannot:** It names that an ending was made and roughly by what. It does not name who.

### r3 — Deathly Premonition

**functions:** reveal, foresee · **gainAxes:** scope, duration · **gains:** broaden · **harm:** none

**grants:** ⛔ MARROW READS EVERY ENDING IN A PLACE AT ONCE, ordered by when — and which of them can still be turned aside, and what it would take. ⚠️ INCLUDING YOURS, and it will not leave while it is happening.
...
**L1 · e4 · threnodist · wild_nanite · shape `reveal` · harm `incapacitating`**  
**status:** ⚠️ no crit  
**ability functions:** bind, sustain

> Speak a name you carry and the room remembers that person as they WERE — not the softened version, not the useful one. Lies about the dead do not hold while you hold the name. The Threnodists' keeping-craft.

**notFor:** Raising, speaking with, or asking anything of the dead; a name you never learned; making anyone feel better about it.

### r1 — Name Held

**functions:** sustain · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** none

**grants:** Speak a name you carry and the room remembers that person as they WERE — not the softened version, not the useful version. Lies about the dead do not hold while you hold the name.
...
**functions:** sustain, bind · **gainAxes:** scope · **gains:** broaden · **harm:** none

**grants:** Hold several, or hold one long enough that a place keeps them — a threshold, a stone, a hall that will not let the name go crooked.

**cannot:** Holding costs, and the names you carry do not leave you between uses. A Threnodist knows exactly how many they hold.

### r3 — Whole Lament

**functions:** sustain, bind · **gainAxes:** scope · **gains:** deepen · **harm:** none

**grants:** Everyone a place has lost, held at once, correctly. Communities have changed their minds about their own history under this.
...
**bounds:** you must have KNOWN them or been told truly · it CORRECTS memory; it does not summon · the names you carry do not leave you between uses
...
**status:** ⚠️ no crit · gated  
**ability functions:** empower

> Sing the names of the lost — all of them — and for the length of the song they are held present rather than gone. The Threnodist naming-song, and the deep work of those who refuse to let go be the same as forget.

**notFor:** It holds the lost in memory, it does not return them — a name kept is not a life restored. And to sing all the names is to carry all the losses at once, for the length of the song and after.
...
**functions:** empower · **gainAxes:** damage, autonomy · **gains:** deepen · **harm:** none
