...
## 1. Attended End  ·  `the_attended_end`
...
## 2. Carried Name  ·  `carried_name`

**L1 · e4 · threnodist · wild_nanite · shape `healing` · harm `none`**  
**status:** ⚠️ no crit  
**ability functions:** restore

> ⛔ YOU HOLD HOW A PERSON ACTUALLY IS, AND THE CRAFT PULLS THEM BACK TOWARD IT. Speak a name you carry and what has been done to them starts to come undone — the rewriting, the corruption, the thing wearing their face. ⚠️ THE MEMORY IS THE TEMPLATE, AND YOU CHOSE IT.

**notFor:** Wounds — this undoes a CONDITION, not an injury (that is Shared Weight). A person you never really looked at. Making anyone feel better about it. ⚠️ And it will not restore them to something they never were.

### r1 — Name Held

**functions:** restore · **gainAxes:** ⛔ NONE · **gains:** deepen · **harm:** none

**grants:** ⛔ SPEAK A NAME YOU CARRY — yours or one other's — AND UNDO A CONDITION LAID ON THEM. Confusion, a compulsion, a false memory, a fear that was put there. They come back toward how you hold them.

**cannot:** One person, within earshot, and you must have KNOWN them. ⚠️ It undoes what was DONE to them; it does not mend a wound and it does not raise the dead.

### r2 — Kept Shape

**functions:** restore · **gainAxes:** targets, quality · **gains:** broaden · **harm:** none

**grants:** ⛔ HOLD SEVERAL AT ONCE, AND REACH DEEPER THINGS — possession, a working set into someone, a name taken off them. ⚠️ What returns is ACCURATE, which is sometimes worse for everyone present.

**cannot:** Holding costs, and the names you carry do not leave you between uses. A Threnodist knows exactly how many they hold.

### r3 — True Shape

**functions:** restore · **gainAxes:** quality, duration · **gains:** deepen · **harm:** none

**grants:** ⛔ THE ANSWER TO BEING REWRITTEN. Someone remade into something else is pulled the whole way back — not healed, RETURNED. ⚠️ This is the cure the world did not have.

**cannot:** ⛔ ONLY AS FAR AS YOUR MEMORY IS TRUE. You restore them toward the person you hold, and no further.

**bounds:** ⛔ YOU CAN ONLY RESTORE SOMEONE TOWARD HOW YOU ACTUALLY HOLD THEM. A Threnodist who never really saw a person restores them badly · ⛔ AND IF YOU HOLD THEM AS BETTER THAN THEY WERE, YOU ARE REWRITING THEM TOO — kindly, which is the Veilwright failure arriving through the front door. The craft cannot tell the difference and neither can they · ⚠️ It undoes a CONDITION, never a wound. A dying man restored is a dying man who is himself again · ⚠️ The names you carry stay with you between uses

---

## 3. Deathsense  ·  `deathsense`

**L1 · e3 · ashwarden · metaphysical · shape `setup` · harm `none`**  
**status:** ⚠️ no crit · *first-gift*  
**ability functions:** foresee, reveal

> Sense death and dying around you — the living whose thread is fraying, the near-gone, the actively failing. Deathsense reads what is HAPPENING NOW. For what has already finished, Palework reads the evidence.

**notFor:** It reads endings; it does not cause them. And it cannot see the future of a death — only the shape of the one already underway.

### r1 — Deathsense

**functions:** foresee · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** —

**grants:** Feel where a living thing is dying or near death. Judge how far along they are. Sense the failing in a person or creature before it shows on the outside.

**cannot:** Reads the living and the dying, not the already-dead. A corpse has nothing left to sense.
...
**cannot:** Knowing the hour does not give you the power to move it, and it will not let you unknow it.
...
**functions:** reveal · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** —
...
> A wail with a death in it — but what travels is not the sound. ⛔ THE GRIEF ITSELF ARRIVES IN ANYONE NEAR ENOUGH TO FEEL IT, and you decide who that is. Those you choose stop; at its height they drop. Everyone else hears a Threnodist mourning and feels only what mourning usually costs a bystander.

**notFor:** Anything that cannot feel — constructs, the set dead, a warded mind. Secrecy. ⚠️ AND IT IS NOT SOUND: walls, corners and stopped ears are no defence, and covering your head does nothing.

### r1 — Wail

**functions:** strike, hinder · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** damaging · imposes

**grants:** ⛔ NAME WHO IT REACHES — about six near you — AND THEY LOSE THEIR NEXT ACTION. Weapons lower, a charge breaks, a pursuit stalls, not because they chose to stop but because for a moment there is nothing in them that can continue. ⚠️ IT IS NOT A SOUND: it goes through walls and around corners because it is not travelling as noise.

**cannot:** ⛔ ONLY WHO YOU NAME. Those you do not choose feel a Threnodist grieving and are otherwise untouched. Anything that cannot feel is unaffected, and those who lose the action act normally after.
...
**grants:** ⛔ THE PULSE. Not a chosen few — EVERYONE NEAR YOU THAT YOU WANT AFFECTED drops unconscious: a knot of guards, a hall, a street, the whole of a room and the rooms next to it. ⚠️ There is no number here. Anyone exposed to it whom you choose is a target, and any who resist lose their next action instead.

**cannot:** ⛔ THE UNCHOSEN ARE UNTOUCHED however close they stand — allies in the middle of it feel a Threnodist grieving and nothing else. ⚠️ Anything that cannot feel is unaffected, and exposure is the limit: what the grief cannot reach, it cannot take.
...
**bounds:** ⛔ THERE MUST BE A DEATH OR A DYING. This is a trade and it needs its occasion · ⚠️ IT DOES NOT READ WHAT ENDED — that is True Account, Attunement's deathsense, or Marrow's bond. This is the TRADE, not the sight · ⚠️ IT READS WHAT ENDED — it does not prevent an ending. Marrow's own boundary: 'will not hasten an ending, ever, and cannot prevent one' · ⛔ ATTENDING A BODY BLOCKS Set Hand, Ask the Dead and Draw Down on it — one body or site per attending · ⚠️ standing is regional and earned; where you have handled a death badly, none of it works · ⛔ r3 rules on the death and nothing else; a standing law outranks it
...
**notFor:** Anything that cannot feel; armour — this does not pierce soak, it makes what gets past it worse.
...
**functions:** strike, hinder · **gainAxes:** damage, quality · **gains:** deepen · **harm:** damaging

**grants:** ⛔ ANTISOAK 5 FIRST, THEN 3d6 — you open the grief they have been protecting and strike into it, so your own blow lands against the vulnerability you just created.
...
**bounds:** ⛔ ANTISOAK APPLIES ONLY TO DAMAGE THAT ALREADY GOT PAST SOAK. A blow fully absorbed adds nothing · ⚠️ IT DOES NOT PIERCE SOAK — a craft that pierces (Ki Wield) ignores soak AND still adds the antisoak, so the two stack · ⛔ r3 PERSISTS UNTIL A MENDING CRAFT LIFTS IT; rest does not close it · anything that cannot feel is unaffected
...
**status:** crit · obscure  
**ability functions:** conceal

> Open a grief wide enough that everything else you are goes unread underneath it. ⚠️ THE COVER IS THE SIZE OF THE FEELING, NOT ITS HONESTY — a real grief is simply the easiest one to open that wide, and the one that costs you something to use.

**notFor:** ⚠️ A HEART WITH NOTHING TO OPEN — you need a grief big enough to hide behind, whatever its source. Concealing a THING, a place, or a body (that is Umbracraft). And it does not make you unseen — you are extremely visible. You are simply unreadable.

### r1 — Open Weeping

**functions:** conceal · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** none

**grants:** ⛔ DECLARE OBSCURE IN THE SENSE SLOT. Open a grief and your intent goes unread beneath it — anyone reading your feeling-state finds the grief, entire, and nothing under it.

**cannot:** One person: you. And you give up your own read to do it — you are grieving, not watching.

### r2 — Shared Mourning

**functions:** conceal · **gainAxes:** targets · **gains:** broaden · **harm:** none

**grants:** Draw someone beside you into the mourning and cover them too. ⚠️ THEY DO NOT HAVE TO BE GRIEVING — yours is loud enough for both, which is what a grief-house is FOR.

**cannot:** They must be within arm's reach and willing to be held. It covers what they FEEL, never what they say or do.

### r3 — Grief-House

**functions:** conceal · **gainAxes:** scope, targets · **gains:** broaden · **harm:** none

**grants:** ⛔ THE FULL VOICE. The mourning fills the space and every read attempted inside it comes back with the grief and nothing else — and per the tie rule, a tie here is yours.

**cannot:** ⚠️ It ends when you stop, and you cannot hold it and act. The room knows exactly where you are the whole time.

**bounds:** ⛔ IT HIDES A FEELING, NEVER A FACT. What you know, what you carry and where you stand are all still plainly readable · ⚠️ You are not concealed — you are the loudest thing in the room. Only what you MEAN is covered · ⚠️ It costs what grieving costs. You do not get the grief back afterwards
...
**notFor:** Anything you cannot see; a foe already blinded or looking away; killing — this shows an ending, it does not cause one.
...
**notFor:** Living people, entirely — weakening a person is The Grey Hand's whole job and none of Wither's. This ages and rots THINGS: structures, barricades, terrain, growth, and the once-living material a thing was made from. It does not wound, because there is nothing here that touches a body.
...
**notFor:** They knew what they knew. A murdered man may not know who killed him. And they will not stay: each question costs them something, and the Ashwardens hold that asking a fourth is a cruelty.
...
> ⚠️ RETRIEVAL. The Ashwarden road runs both ways, and this is the walk back. You reach for someone who has died and bring them up the ladder — from the threshold, and at rank, from further down. THE DEEPER THEY HAVE SUNK, THE HARDER THE REACH AND THE MORE IT COSTS YOU.

**notFor:** The SEALED, who refuse every road. Anyone dead of a cause still acting — pull them back into a poison and they simply die again. And it does not heal: what comes back comes back exactly as hurt as it went down.

### r1 — From the Threshold

**functions:** heal, summon · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** incapacitating

**grants:** Reach someone at THE THRESHOLD (dead within a day). A standard roll against their depth; success walks them back up.

**cannot:** Anything past the threshold. If the reach fails, THEY SINK — a failed calling costs them a rung.

### r2 — From the Near Dark

**functions:** heal, summon · **gainAxes:** range, duration, damage · **gains:** deepen · **harm:** incapacitating

**grants:** Reach into THE NEAR DARK (up to a month down). Harder, and the roll is against a longer road.

**cannot:** The deep dark. And the further you reach, the more of the way back you walk yourself.

### r3 — From the Deep Dark

**functions:** heal, summon · **gainAxes:** range · **gains:** deepen · **harm:** lethal

**grants:** Reach into THE DEEP DARK — months gone, the road nearly closed. It works rarely and it is never free.
...
**bounds:** THE SEALED REFUSE EVERY ROAD — no rank reaches depth 3 · A FAILED REACH SINKS THEM A RUNG; at the deep dark it SEALS them · WHAT COMES BACK COMES BACK AS HURT AS IT WENT DOWN — this is retrieval, not healing · you walk the road too, and the walking MARKS YOU
...
**functions:** strike, heal · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** damaging
...
**ability functions:** empower, ward

> Sing the names of the lost — all of them — and for the length of the song they are held present rather than gone. ⛔ AND A NAME HELD IS A NAME THAT CANNOT BE MEDDLED WITH, and one that stays reachable longer.

**notFor:** It holds the lost in memory, it does not return them — a name kept is not a life restored. ⚠️ It makes the road back longer-lived; walking it is Calling Back's work, never this. And to sing all the names is to carry all the losses at once.

### r1 — Names of the Lost

**functions:** empower · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** none

**grants:** Sing the names of the lost, holding them present in memory for the length of the lament.
...
**functions:** ward · **gainAxes:** duration, quality · **gains:** deepen · **harm:** none

**grants:** ⛔ A NAME SUNG IS A NAME WARDED. The attended dead cannot be raised, bound, worn or spoken through by anyone else — and they SINK SLOWER: a warded name holds at THE THRESHOLD past its day, and in THE NEAR DARK past its month. ⚠️ The road back stays open longer because someone is still holding it.

**cannot:** ⛔ IT DOES NOT WALK THEM BACK — that is Calling Back, and this only keeps the rung they are on. It cannot recover THE SEALED. And it wards only names you actually sang, which means someone had to know them.

**bounds:** IT CANNOT RESTORE THE DEAD, ONLY ATTEND THEM · A NAME KEPT IS NOT A LIFE RETURNED
...
**status:** crit · dmg:feeling  
**ability functions:** bind

> ⚠️ THE HEART-TUNERS' CRAFT. Pathos SHARES a feeling; this INSTALLS one at a weight no body holds. Not sorrow — sorrow's full weight, all at once, without the years that usually come with it. Some hearts stop. Most do not, and those people are changed.

**notFor:** A heart with nothing to grieve — it uses THEIR losses, not invented ones, so someone who has lost nothing is nearly immune. And it CANNOT BE AIMED at an outcome: you set the weight down, the body decides.

### r1 — Grief That Stops

**functions:** bind · **gainAxes:** ⛔ NONE · **gains:** broaden · **harm:** incapacitating

**grants:** Set the full weight of their own losses on them at once. They are overwhelmed and afterward not the same.
...
> End one living thing. No wound, no struggle, no argument — it simply stops. The Fates' shears, the deepest thing the Ashwardens hold, and taught to almost nobody.

**notFor:** One thing, once, and it costs you enormously. It cannot be aimed at what has no thread — a machine, a figure, a Precursor working. And it cannot be taken back. There is no version of this you get to regret quietly: it is done, it is witnessed, and it is yours.

### r1 — The Cut Thread

**functions:** strike · **gainAxes:** ⛔ NONE · **gains:** — · **harm:** lethal

**grants:** End one living thing. No wound, no struggle, no argument. It simply stops.
...
**bounds:** it costs your whole remaining energy pool and leaves you at zero, unable to use any craft until a full night's rest · IT IS UNMISTAKABLE TO ANYONE WATCHING
