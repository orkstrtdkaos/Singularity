...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["380: every source the schools reach WITH has a band entry — the join between two content files",
            ...
            "380: …and a source can have no band and NO floor — nanite, which answers to supply, not ground",
  ...
  },
  {
    ...
    gates: ["367: an NPC with only a role no longer leads with 'a person'",
            ...
            "367c: …and whoIs now hands it to the portrait, ahead of anything derived",
