...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["329: a nested `{location:{id}}` yields the id, not the text of an object",
            ...
            "329b: nothing writes generated.location except the one guarded commit",
            "329b: …and that commit refuses a name that is a coerced object",
