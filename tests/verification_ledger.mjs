...
const LEDGER = [
  ...
  {
    id: "SNG-414", ask: "(Erik) the map is unusable at medium-to-high zoom — plan a refactor: world globe, then a leader 2D map, then a location map; split the Foothills; bake the base then author per region",
  ...
  },
  {
    ...
    gates: ["403: the elevation the CONTOURS read is continuous — a level set of a staircase is a grid of rectangles",
            "403: the contour interval FOLLOWS the zoom — a leader map carries leader relief",
  ...
  },
  {
    ...
    gates: ["402: the asset's vector hydrology and place names REACH the viewer — the writer-with-no-reader closed",
            ...
            "402: span drives the level of detail — a hemisphere reads 180°, a leader view reads under 30°",
  ...
  },
  {
    ...
    gates: ["272/273: every authored stage effect is REACHABLE by the reader",
            ...
            "272/273: ⛔ a LEADER arc scoped to a region is in force THERE",
