...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["SNG-414: no region extent exceeds a full turn — longitude wraps, and the window knows it",
            ...
            "SNG-414: …and the COMPUTED centre lands within a few degrees of ground of hers, for the 34 with no map",
  ...
  },
  {
    ...
    gates: ["399: every figure with an authored imagePrompt is DRAWN from it — the portrait is not name-and-role guesswork",
