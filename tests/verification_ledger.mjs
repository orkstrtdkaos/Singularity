...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["SNG-392: the applied hierarchy matches Aevi's corrected census — 25 regions, 28 settlements, 65 sites",
  ...
  },
  {
    ...
    gates: ["SNG-398: no site sits beyond ONE DAY of its parent except the KNOWN census — 65 of 65 today; the ratification empties it",
            "SNG-398: …and with the census emptied the gate FIRES on all 65 — red observed, as the spec demanded"],
  ...
  },
  {
    ...
    gates: ["SNG-394: no two river names bind to one pathIndex — a shared stem is two lost places, not one found",
