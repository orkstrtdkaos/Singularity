...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["390: the terrain asset decodes — four channels, two grids, 118 locations",
            "390: …and it says in the file that it is baked output with no generator",
  ...
  {
    id: "SNG-391", ask: "(Erik) do the milestone effects — the harm-rung drops and the novel-penalty removal I flagged and never built",
    ...
    gates: ["391: every ⚑ milestone is transcribed into a structured effect — the marker has a reader now",
            "391: …and an effect the engine cannot honour carries a WRITTEN reason, never silence",
            "391: no ⚑ milestone is transcribed as `unclassified` — that value exists to fail loudly",
            "391: milestones are ABSOLUTE, not cumulative — rank 14 grants two rungs, not three",
            "391: …and a rank below the milestone grants nothing",
            "391: a blocked effect never appears in the LIVE map — a caller cannot act on an unbuilt promise",
            "391: agility 7 softens the blow — an assassin's table stops producing `slain`",
            "391: …but softening stops at `spared` when you are alone — nobody revives you but somebody",
            "391: the roll and the softening are BOTH reported — a mercy the player is not told about cannot be learned",
            "391: rapport names the places at your side — 1, then 2 at rank 4, 3 at 7, 4 at 10",
            "391: a join past capacity is REFUSED, and refused where joins really happen (recruit, not the dead op)",
            "391: an over-capacity save loses NOBODY — the cap refuses a new join, it never ejects",
            "391: …and someone who left can come back even at capacity",
            "391: with no ladder passed the cap does not apply — every existing caller keeps working"],
