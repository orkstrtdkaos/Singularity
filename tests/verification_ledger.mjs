...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["394b: every pin stands on its own terrain — the water census is EMPTY across all 118, via the viewer's own conversion",
  ...
  },
  {
    ...
    gates: ["390: the terrain asset decodes — four channels, two grids, 118 locations",
