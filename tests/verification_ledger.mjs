...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["366: delegated work advances even when the CHARACTER clock has not moved",
            ...
            "366: only the assignment pass was lifted above the early return — the rest keeps character cadence",
  ...
  },
  {
    ...
    gates: ["365: the wheel has an Attainable filter",
  ...
  },
  {
    ...
    gates: ["363: a small event a region away does NOT reach you — Erik's exact complaint",
            "363: …but a large one does — magnitude, never merit (SNG-281's rule, reused)",
            "363: an event in your own community always reaches you, however small",
            "363: impactsLocal bypasses the distance gate entirely",
            "363: an unplaceable event is judged on weight alone, not dropped",
