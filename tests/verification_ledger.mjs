...
const LEDGER = [
  ...
  },
  {
    ...
    gates: ["382: the source mixes are LOADED, not merely registered — a loadRule call, not a CI-only read",
            "382: every tradition that has schools also has an authored mix — the two tables agree",
            "382: a `combination` primary is only used where the mix really is balanced — not as a shrug",
            "382: every mix WEIGHT names a ratified source, whatever the primary says",
